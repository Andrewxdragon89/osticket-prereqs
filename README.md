...
1.) The first thing I did when creating OSticket was use a Azure Virtual Machine in Azure. I made sure the machine had 2 vcpus and was a windows 10 machine.
